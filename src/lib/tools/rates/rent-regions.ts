...
export const PROVINCES: Province[] = [
  ...
  },
  {
    ...
    name: "충청북도",
    districts: [
      { code: "43110", name: "청주시상당구" },
      { code: "43111", name: "청주시서원구" },
      { code: "43112", name: "청주시흥덕구" },
      { code: "43113", name: "청주시청원구" },
      { code: "43130", name: "충주시" },
      { code: "43150", name: "제천시" },
      { code: "43720", name: "보은군" },
      { code: "43730", name: "옥천군" },
  ...
  },
  {
    ...
    name: "충청남도",
    districts: [
      { code: "44131", name: "천안시동남구" },
      { code: "44133", name: "천안시서북구" },
      { code: "44150", name: "공주시" },
      { code: "44180", name: "보령시" },
      { code: "44200", name: "아산시" },
      { code: "44210", name: "서산시" },
  ...
  },
  {
    ...
    name: "경상남도",
    districts: [
      { code: "48121", name: "창원시의창구" },
      { code: "48123", name: "창원시성산구" },
      { code: "48125", name: "창원시마산합포구" },
      { code: "48127", name: "창원시마산회원구" },
      { code: "48129", name: "창원시진해구" },
      { code: "48170", name: "진주시" },
      { code: "48220", name: "통영시" },
      { code: "48240", name: "사천시" },
      { code: "48250", name: "김해시" },
...
/** 시/도 코드로 Province 찾기 */
export function getProvince(sidoCode: string): Province | undefined {
  return PROVINCES.find((p) => p.code === sidoCode);
}

/** 시/군/구 코드로 District 찾기 */
export function getDistrict(code: string): { province: Province; district: District } | undefined {
  for (const prov of PROVINCES) {
    const d = prov.districts.find((dd) => dd.code === code);
    if (d) return { province: prov, district: d };
  }
  return undefined;
}
